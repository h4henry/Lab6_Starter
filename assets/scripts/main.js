...
function addRecipesToDocument(recipes) {
  ...
  for(const card in recipes){
    const cardElement = document.createElement('recipe-card');
    cardElement.data = recipes[card];
...
function initFormHandler() {
  ...
  cardElement.data = recipeObject;
  console.log(cardElement.data);
